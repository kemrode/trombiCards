...
";
    ...
    public function block_updateNotif($context, array $blocks = [])
    {
        ...
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["notification"] ?? null), "notifId", [], "any", false, false, false, 16), "html", null, true);
        ...
        // line 19
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["notification"] ?? null), "notifTitle", [], "any", false, false, false, 19), "html", null, true);
        echo "\">
                    </div>
                    <div class=\"notifText notifText__zindex--index\">
                        <textarea name=\"notifText\" >";
        // line 22
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["notification"] ?? null), "notifTxt", [], "any", false, false, false, 22), "html", null, true);
        echo "</textarea>
                    </div>
                </div>
                <div class=\"btnBox\">
...
";
    ...
    {
        return array (  91 => 22,  85 => 19,  79 => 16,  70 => 9,  66 => 8,  61 => 6,  57 => 5,  52 => 3,  48 => 2,  37 => 1,);
    }
